...
This repository contains material for the course _Applied Mathematics: an Introduction to Scientific Computing by Numerical Analysis_, academic year 2025-2026.
...
- Anna Ivagnes (<aivagnes@sissa.it>)
...
Lectures are held live on Tuesdays from 16:00 to 18:00, and on Wednesdays from 09:00 to 11:00 in the main SISSA Building. The classes schedule is available [here](https://www.math.sissa.it/course/phd-course/applied-math-numerical-analysis-and-scientific-computing).
...
#### Module 1 (Basis of Numerical Analysis - Part I)
...
#### Module 2 (Basis of Numerical Analysis - Part II)
...
#### Module 3 (Basis of Numerical Modeling)
...
#### Module 4 (Numerical Analysis with Python - Ms. Anna Ivagnes / Dr. Federico Pichi)
